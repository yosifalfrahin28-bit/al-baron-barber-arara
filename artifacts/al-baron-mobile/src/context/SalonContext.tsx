...
type SalonContextValue = {
  ...
  bookAppointment: (details: { date: string; time: string; barber: string; service: string; ageCategory?: string }) => Promise<void>;
...
export function SalonProvider({ children }: { children: ReactNode }) {
  ...
  const bookAppointment = async (details: { date: string; time: string; barber: string; service: string; ageCategory?: string }): Promise<void> => {
